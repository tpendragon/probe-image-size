...
module.exports = function () {
  console.log("Instantiating ParserStream")
  var parser = new ParserStream();

  console.log("Reading Header")
  // read header
  parser._bytes(8, function (data) {
    console.log("Checking TIFF signature")
    console.log(data)
    ...
    console.log("Got to safe Skip");

    // skip until IFD
    safeSkip(parser, count, function () {
      console.log("Reading IFD entries.");
